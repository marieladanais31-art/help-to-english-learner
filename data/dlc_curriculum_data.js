...
const SPEAKING_ENGLISH_PACES = {
  pace1001: {
    paceNum: "1001", title: "Speaking English — Pace 1001",
    theme: "Classroom & Body Parts",
    color: "#4ECDC4",
    pages: [
      { pages: "1-5",  words: ["Chair","Table","Door","Window","Floor","Head","Shoulders","Knees","Toes"],
        song: "Head, Shoulders, Knees and Toes", commands: ["Sit down","Stand up","Point to...","Touch your head"] },
      { pages: "6-10", words: ["Eye","Ear","Wall","Ceiling","Mouth","Nose","Desk","Office"],
        commands: ["Look at...","Touch your nose","Show me your ear","Point to the ceiling"] },
      { pages: "11-15", words: ["Jump","Hands","Fingers","Foot","Feet","Circle","Boy","Square","Book","Girl"],
        commands: ["Hop","Touch your toes","Stop","Walk","Show me five fingers"] },
      { pages: "16-20", words: ["Pencil","Paper","Arm","Elbow","Neck","Eraser","Supervisor","Triangle","Rectangle","Thumb"],
        commands: ["Give me the pencil","Pick up the paper","Put down the eraser","Thumbs up"] },
      { pages: "21-25", words: ["Wave","Leg","Back","Bible","PACE","Pen","Flag","Oval","Heart"],
        commands: ["Wave your hand","Show me the Bible","I am a boy / girl","Salute the flag"] },
    ]
  },
  pace1002: {
    paceNum: "1002", title: "Speaking English — Pace 1002",
    theme: "Family, Colors & Animals",
    color: "#A29BFE",
    pages: [
      { pages: "1-5",  words: ["Baby","Hair","Woman","Women","Man","Men","Star","Chart"],
        commands: ["He is a man","She is a woman","Look at the star chart","Touch your hair"] },
      { pages: "6-10", words: ["Dog","Cat","Sing","Song","Glue","Crayon","Lips","Tongue","Tooth","Teeth"],
        commands: ["Sing a song","Clap your hands","Show me your teeth","Color with the crayon"] },
      { pages: "11-15", words: ["Puppy","Kitten","Trash","Box","Learning Center","Cheek","Chin"],
        commands: ["Throw away the trash","Open the box","Close the box","Touch your cheek"] },
      { pages: "16-20", words: ["Dress","Shirt","Pants","Mother","Father","Son","Daughter","Skirt","Blouse"],
        commands: ["This is my mother","This is my father","What is this?","It is a shirt"] },
      { pages: "21-25", words: ["Shoe","Shoes","Sock","Socks","Sister","Brother","Grandfather","Grandmother"],
        commands: ["Put on your shoes","Take off your socks","Where is your sister?","Hug your grandmother"] },
    ]
  },
  pace1003: {
    paceNum: "1003", title: "Speaking English — Pace 1003",
    theme: "Clothing, Kitchen & Home",
    color: "#FF6B6B",
    pages: [
      { pages: "1-5",  words: ["Vest","Coat","Sweater","Umbrella","Watch","Clock"],
        commands: ["What time is it?","It is ... o'clock","Put on your coat","Open the umbrella"] },
      { pages: "6-10", words: ["House","Belt","Glove","Scarf","Mitten","Apartment","Hood","Hat","Tie"],
        commands: ["I live in a house","Put on your hat","Fasten your belt","Wear your scarf"] },
      { pages: "11-15", words: ["Cap","Glasses","Zipper","Buttons","Peacock","Bird","Bow"],
        commands: ["Zip up the zipper","Button up your shirt","Look at the peacock","Put on your glasses"] },
      { pages: "16-20", words: ["Kitchen","Refrigerator","Stove","Sink","Pan","Lid","Kettle","Jar","Glass","Pet"],
        commands: ["In the kitchen...","Open the refrigerator","Wash the glass","Cover the pan with the lid"] },
      { pages: "21-25", words: ["Mop","Water","Plate","Fork","Cup","Spoon","Dish","Knife","Can"],
        commands: ["Pass me the fork","Drink some water","Clean with the mop","Eat with the spoon"] },
    ]
  },
  pace1004: {
    paceNum: "1004", title: "Speaking English — Pace 1004",
    theme: "Bedroom, Toys, Bathroom & City",
    color: "#55EFC4",
    pages: [
      { pages: "1-5",  words: ["Quilt","Tan","Team","Mitt","Bat","Bed","Lamp","Pillow","Asleep","Awake"],
        commands: ["Time to go to sleep","Wake up!","Turn on the lamp","Make your bed"] },
      { pages: "6-10", words: ["Turtle","Bear","Doll","Block","Blocks","Hanger","Puzzle","Bunny","Game"],
        commands: ["Let us play a game","Pick up the blocks","Put the shirt on the hanger","Hug the bunny"] },
      { pages: "11-15", words: ["Stool","Mat","Tub","Dirty","Brush","Shower","Toothbrush","Leak","Soap","Comb","Big","Little","Tall","Short"],
        commands: ["Brush your teeth","Wash with soap","Comb your hair","Take a shower","I am big / little"] },
      { pages: "16-20", words: ["Mouse","Mice","Needle","Pin","Yarn","Thread","Spool","Rat","Top","Bottom"],
        commands: ["On top of the table","At the bottom","A little mouse","Thread the needle"] },
      { pages: "21-25", words: ["Bus","Street","Track","Jeep","City","Train","Car","Traffic light","Taxi","Short","Long"],
        commands: ["Stop at the red light","Go on green","Ride the bus","Look at the train"] },
    ]
  },
  pace1005: {
    paceNum: "1005", title: "Speaking English — Pace 1005",
    theme: "Community Helpers & Professions",
    color: "#FDCB6E",
    pages: [
      { pages: "1-5",  words: ["Truck","Garage","Policeman","Tire","Gasoline","Whistle","Sidewalk","Fireman","Fire"],
        commands: ["The policeman helps us","The fireman puts out fire","Walk on the sidewalk","Blow the whistle"] },
      { pages: "6-10", words: ["Doctor","Medicine","Bottle","Hospital","Pills","X-ray","Vitamins","Nurse","Dentist"],
        commands: ["Open your mouth","Take your vitamins","The doctor helps sick people","Brush for the dentist"] },
      { pages: "11-15", words: ["Horse","Pilot","Jet","Airport","Sky","Sun","Bicycle"],
        commands: ["The pilot flies the jet","Look at the sky","Ride a bicycle","Feed the horse"] },
      { pages: "16-20", words: ["Smell","Gift","Stamp","Gerbil","Perfume","Store","Post Office","Mail carrier","Letter"],
        commands: ["Send a letter","Go to the post office","Open the gift","Put a stamp on the letter"] },
      { pages: "21-25", words: ["Bread","Pie","Bakery","Gum","Cookie","Parrot","Cockatoo","Library"],
        commands: ["Buy bread at the bakery","Read a book in the library","Eat a cookie","Listen to the parrot"] },
    ]
  },
  pace1006: {
    paceNum: "1006", title: "Speaking English — Pace 1006",
    theme: "City, Park, Nature & Tools",
    color: "#E17055",
    pages: [
      { pages: "1-5",  words: ["Museum","Caterpillar","Building","Factory","Butterfly","School","Gymnasium","Restaurant","Roof"],
        commands: ["Let us go to school","Eat at the restaurant","Look at the butterfly","Visit the museum"] },
      { pages: "6-10", words: ["Park","Path","Squirrel","Nut","Bridge","Tree","Pigeon","Grass","Flower","Smooth","Rough"],
        commands: ["Walk on the path","The squirrel eats a nut","Smell the flower","Cross the bridge"] },
      { pages: "11-15", words: ["Slide","Swan","Bug","Duck","Sailboat","Kite","Lake","Swings","Marbles"],
        commands: ["Fly a kite","Play on the swings","Go down the slide","The swan swims in the lake"] },
      { pages: "16-20", words: ["Carpenter","Nail","Ant","Rope","Saw","Hammer","Stick","Grasshopper"],
        commands: ["The carpenter works with wood","Hit the nail with the hammer","Jump like a grasshopper"] },
      { pages: "21-25", words: ["Wood","Paint","Brick","Cricket","Chain","Tack","Inchworm","Fuse","Tube"],
        commands: ["Paint the wall","Build with brick","Listen to the cricket","Watch the inchworm"] },
    ]
  },
  pace1007: {
    paceNum: "1007", title: "Speaking English — Pace 1007",
    theme: "Royalty, Nature & Farm",
    color: "#6C5CE7",
    pages: [
      { pages: "1-5",  words: ["Crown","King","Lace","Judge","Lion","Antelope","Gown","Queen","Gem"],
        commands: ["The king wears a crown","The queen has a gown","The lion roars"] },
      { pages: "6-10", words: ["Vase","Rose","Bee","Wing","Fly","Violets","Nightingale","Ribbon"],
        commands: ["The bee has wings","Put flowers in the vase","Tie the ribbon","Listen to the nightingale"] },
      { pages: "11-15", words: ["Cow","Dirt","Barn","Farmer","Farm","Garden","Seeds","Spring"],
        commands: ["Plant the seeds","The farmer works on the farm","The cow is in the barn"] },
      { pages: "16-20", words: ["Well","Gate","Ox","Fence","Mule","Hoe","Goat","Yoke"],
        commands: ["Open the gate","Draw water from the well","The ox pulls the plow"] },
      { pages: "21-25", words: ["Wind","Goose","Pig","Rainbow","Rain","Windmill","Cloud","Chime","Windy","Cloudy","Sunny","Rainy"],
        commands: ["It is windy today","Look at the rainbow","Feed the pig","Listen to the wind chime"] },
    ]
  },
  pace1008: {
    paceNum: "1008", title: "Speaking English — Pace 1008",
    theme: "Mountains, Ocean & Forest",
    color: "#00B894",
    pages: [
      { pages: "1-5",  words: ["Fish","Valley","Mountain","Sunfish","Net","Waterfall","River"],
        commands: ["Climb the mountain","Swim in the river","Catch fish with a net","Look at the waterfall"] },
      { pages: "6-10", words: ["Moth","Tent","Lantern","Day","Cot","Owl","Night","Moon"],
        commands: ["Sleep in the tent","Turn on the lantern","The owl flies at night","The moon is bright"] },
      { pages: "11-15", words: ["Walrus","Seal","Whale","Eel","Ship","Ocean","Sand","Shell","Hole"],
        commands: ["Sail on the ship","Find a shell in the sand","The whale is big","Dig a hole in the sand"] },
      { pages: "16-20", words: ["Town","Road","Ground","Leaves","Pine cone","Rake","Leaf","Pumpkin"],
        commands: ["Rake the leaves","Walk on the road","Pick a pumpkin","Find a pine cone"] },
      { pages: "21-25", words: ["Web","Crack","Spider","Skunk","Forest","Rock","Vine","Deer"],
        commands: ["The spider spins a web","Look at the deer in the forest","Climb over the rock"] },
    ]
  },
  pace1009: {
    paceNum: "1009", title: "Speaking English — Pace 1009",
    theme: "Wilderness, Seasons & Food",
    color: "#D63031",
    pages: [
      { pages: "1-5",  words: ["Rabbit","Limb","Quail","Log","Ax","Twig","Stones","Loon"],
        commands: ["Chop the log with an ax","The rabbit hops","Skip stones on water"] },
      { pages: "6-10", words: ["Yak","Hill","Moose","Snow","Ibex","Sled","Spring","Autumn","Summer","Winter","Ice"],
        commands: ["Ride on the sled","Snow in winter","Warm in summer","Cool in autumn"] },
      { pages: "11-15", words: ["Whip","Wagon","Seat","Sagebrush","Armadillo","Stagecoach","Buffalo","Wheel","Lizard"],
        commands: ["Ride in the wagon","Look at the buffalo","Turn the wheel","The lizard runs"] },
      { pages: "16-20", words: ["Hen","Chick","Juice","Pancakes","Waffles","Milk","Cereal","Orange","Egg"],
        commands: ["Drink your milk","Eat pancakes for breakfast","Crack the egg","Peel the orange"] },
      { pages: "21-25", words: ["Pizza","Peanut","Apple","Cracker","Banana","Butter","Jam","Grapes","Peanut butter"],
        commands: ["Spread butter on bread","Eat a banana","Share the grapes","Eat a slice of pizza"] },
    ]
  },
  pace1010: {
    paceNum: "1010", title: "Speaking English — Pace 1010",
    theme: "Fruits, Vegetables, Home & Music",
    color: "#0984E3",
    pages: [
      { pages: "1-5",  words: ["Prune","Pear","Cherry","Cheese","Pineapple","Peach","Lemon","Strawberry","Plum"],
        commands: ["A sweet strawberry","Sour lemon","Cut the pineapple","Eat a red cherry"] },
      { pages: "6-10", words: ["Unicorn","Potato","Lettuce","Carrot","Tomato","Onion","Beans","Peas","Cottage cheese"],
        commands: ["Eat your vegetables","Cut the tomato","Peel the carrot","Chop the onion"] },
      { pages: "11-15", words: ["Pepper","Celery","Corn","Rice","Noodle","Macaroni","Wheat","Oats","Flour"],
        commands: ["Cook the macaroni","Bake with flour","Eat sweet corn","Cook the rice"] },
      { pages: "16-20", words: ["Telephone","Iron","Vacuum","Fan","Radio","Beef","Toaster","Newspaper","Toast"],
        commands: ["Answer the telephone","Turn on the fan","Make toast","Listen to the radio"] },
      { pages: "21-25", words: ["Music","Harp","Guitar","Violin","Horn","Piano","Keyboard","Drum"],
        commands: ["Play the piano","Strum the guitar","Beat the drum","Play the violin"] },
    ]
  },
  pace1011: {
    paceNum: "1011", title: "Speaking English — Pace 1011",
    theme: "Animals, Zoo & Celebration",
    color: "#E84393",
    pages: [
      { pages: "1-5",  words: ["Hound","Goldfish","Fish","Bowl","Nest","Doghouse","Coop","Chicken","Birdhouse","Bone","Zero"],
        commands: ["Feed the goldfish","The hound is in the doghouse","The chicken is in the coop","Number zero"] },
      { pages: "6-10", words: ["Ostrich","Jacks","Football","Top","Camera","Bell","Yo-yo"],
        commands: ["Take a picture with the camera","Ring the bell","Play with the yo-yo","Throw the football"] },
      { pages: "11-15", words: ["Cage","Hippopotamus","Jaguar","Pool","Okapi","Giraffe","Zoo"],
        commands: ["Visit the zoo","The giraffe has a long neck","Swim in the pool","The jaguar runs fast"] },
      { pages: "16-20", words: ["Frog","Race","Puppet","Sheep","Vole","Lamb","Wool"],
        commands: ["The frog jumps","Run a race","Soft wool from the sheep","Play with the puppet"] },
      { pages: "21-25", words: ["Clown","Pony","Cake","Candy","Ice cream","Balloon","Popcorn"],
        commands: ["Blow up the balloon","Eat ice cream and cake","Ride the pony","Eat hot popcorn"] },
    ]
  },
  pace1012: {
    paceNum: "1012", title: "Speaking English — Pace 1012",
    theme: "Creation, World & Faith",
    color: "#2D3436",
    pages: [
      { pages: "1-5",  words: ["Cash","Cent","Kangaroo","Quarter","Emu","Fox","Toad"],
        commands: ["Count the coins","The kangaroo carries her baby","A quarter is 25 cents"] },
      { pages: "6-10", words: ["Monkey","Yacht","Quart","Match","Trout","Civet","Key"],
        commands: ["Unlock the door with the key","The monkey climbs the tree","A quart of milk"] },
      { pages: "11-15", words: ["Tiger","Camel","Zebra","Elephant","Ark","Ape"],
        commands: ["Noah built the Ark","The zebra has stripes","The camel lives in the desert"] },
      { pages: "16-20", words: ["Globe","Earth","Map","Land","World","Country"],
        commands: ["Find your country on the map","God made the Earth","Spin the globe"] },
      { pages: "21-25", words: ["Jesus","Brain","Letter","Church","Heaven","God"],
        commands: ["Jesus loves me","Go to church on Sunday","God lives in Heaven","God gave us a brain to think"] },
    ]
  }
};
